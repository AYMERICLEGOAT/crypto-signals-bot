...
const CLOSED_VARIANTS: ((ctx: ClosedContext) => string)[] = [
  ...
  (ctx) =>
    [
      ...
      "Tant que c'est le cas, la stratégie n'émet aucun signal. Aucune exception, aucun signal « quand même ».",
      "",
  ...
  () =>
    [
      ...
      "Ces deux années-là, la stratégie n'a tout simplement rien émis.",
      "",
  ...
  () =>
    [
      ...
      "Taux de réussite 47,7 %, espérance +3,22 % par signal net de frais.",
  ...
  () =>
    [
      ...
      "La moyenne est pourtant de +3,22 %. Les deux sont vrais : les 5 % de meilleurs signaux apportent la totalité du gain. Sans eux, l'espérance tombe à -0,42 %.",
      "",
